...
class FibonacciTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"0,0","1,1","2,1","3,2","4,3","5,5","6,8","7,13","8,21","9,34","10,55", "11,89"})
    public void shouldGenerateFibonacciSequenceNoAdditionalSpace(int input, int expected) {
        MatcherAssert.assertThat(Fibonacci.fibonacciNoAdditionalSpace(input), Matchers.equalTo(expected));
    }
}